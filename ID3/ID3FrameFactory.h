...
namespace ID3 {
	 ...
	 * After creating a FrameFactory object call create(), or call
	 * a static create() method instead. createPair() can also be called
	 * instead as a shortcut method if you want to insert the Frame into
	 * an ID3::FrameMap.
	 * 
	 * NOTE: Whenever a call to create() has invalid parameter values,
	 * a FramePtr holding a "null" UnknownFrame will be returned. Even
	 * if the passed parameter values are valid, the returned Frame may
	 * still be "null" and/or an UnknownFrame.
	 * 
	 ...
	 * 
	 * NOTE: Although a FrameFactory object holds an fstream file
	 * object, it will not close the file upon destruction. You must
	 * close the file manually, after you are finished with the
	 * FrameFactory object.
	 */
	class FrameFactory {
		public:
			 ...
			 * @param tagSize The size of the ID3v2 tags in bytes. It is
			 *                assumed that the tag size has already been
			 *                checked to be smaller than the filesize.
			 */
			...
			/**
			 * Creates a Frame by reading from the given position on the
			 * file passed in the constructor.
			 * 
			 * NOTE: The passed file object must not be closed or null,
			 *       or a "null" UnknownFrame will be returned.
			 *       The read position must also be smaller than the
			 *       ID3v2 tag size.
			 * 
			 * @param readpos The position on the file to start reading
			 *                from.
			 ...
			 * file passed in the constructor.
			 * 
			 * NOTE: The passed file object must not be closed, or a
			 *       "null" UnknownFrame will be returned. The read
			 *       position must also be smaller than the tag size.
			 * 
			 * NOTE: The file object will not be closed during the
			 *       method call.
			 * 
			 * @param file An fstream file object.
			 * @param version The ID3 major version to use.
		...
		protected:
			...
			/**
			 * A private constructor used in static create() method
			 * calls to create frames with content given in the method's
			 * parameter.
			 * 
			...
			/**
			 * A pointer to the fstream object given in the public
			 * constructor.
			 */
			...
			/**
			 * The size of the ID3 tags in bytes, given
