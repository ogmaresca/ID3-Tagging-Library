...
///@pkg ID3.h
const uint8_t ID3::MIN_SUPPORTED_VERSION = 2;

///@pkg ID3.h
const uint8_t ID3::MAX_SUPPORTED_VERSION = 4;

///@pkg ID3.h
const uint8_t ID3::SUPPORTED_MINOR_VERSION = 0;

///@pkg ID3.h
const uint8_t ID3::WRITE_VERSION = 4;
